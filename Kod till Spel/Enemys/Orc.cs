...
public class OrcBase
{
    ...
    //    {
    //        stats.name = "Orc-" + random.Next(1, 3340);
    //    }
    //}
    ...
    //        stats.name = "Shaman-" + random.Next(1, 3340);
    //        LevelCheck(hero);   //Kollar vilken Level Hero är på
    ...
    //        stats.name = "Grunt-" + random.Next(1, 3340);
    //        LevelCheck(hero);   //Kollar vilken Level Hero är på
    ...
    //        stats.name = "DungeonOrcBoss-" + random.Next(1, 6666);
    ...
    //        stats.name = "DungeonOrc-" + random.Next(1, 3340);
    ...
    //        stats.name = "DungeonShaman-" + random.Next(1, 3340);
    ...
    //        stats.name = "DungeonGrunt-" + random.Next(1, 3340);

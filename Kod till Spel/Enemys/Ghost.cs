...
//    {
//        stats.name = "Wraithon-" + random.Next(1, 3340);
//    }
//}
//public class Wraithon : Ghost
//{
//    public Wraithon(Hero hero) : base(hero)
//    {
//        stats.damage = 4;
//        stats.speed = 2;
//        stats.armor = 1.5;
...
//    }
//}
//public class Hauntress : Ghost
//{
//    public Hauntress(Hero hero) : base(hero)
//    {
//        stats.damage = 1.5;
//        stats.speed = 1.2;
//        stats.armor = 2;
...
//        stats.name = "Hauntress-" + random.Next(1, 3340);
//        LevelCheck(hero);   //Kollar vilken Level Hero är på
...
//public class Gravemourn : Ghost
//{
//    public Gravemourn(Hero hero) : base(hero)
//    {
//        stats.damage = 1.2;
//        stats.speed = 0.7;
//        stats.armor = 5.5;
...
//        stats.name = "Gravemourn-" + random.Next(1, 3340);
//        LevelCheck(hero);   //Kollar vilken Level Hero är på
...
//{
//    public GhostBoss(Hero hero) : base(hero)
//    {
...
//        stats.name = "DungeonBoss-" + random.Next(1, 6666);
...
//    }
//}
//public class DungeonWraithon : Ghost
//{
//    public DungeonWraithon(Hero hero) : base(hero)
//    {
//        stats.hp = 30;
//        stats.damage = 4;
//        stats.speed = 2.2;
...
//        stats.name = "DungeonWraithon-" + random.Next(1, 3340);
...
//    }
//}
//public class DungeonHauntress : Ghost
//{
//    public DungeonHauntress(Hero hero) : base(hero)
//    {
//        stats.hp = 35;
//        stats.damage = 2;
//        stats.healing = 1.2;
...
//        stats.name = "DungeonHauntress-" + random.Next(1, 3340);
...
//public class DungeonGravemourn : Ghost
//{
//    public DungeonGravemourn(Hero hero) : base(hero)
//    {
//        stats.hp = 45;
//        stats.damage = 1.5;
//        stats.speed = 0.8;
...
//        stats.name = "DungeonGravemourn-" + random.Next(1, 3340);
